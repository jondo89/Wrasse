...
///////////////////////////////////////////////////
////     VALIDATOR FOR A BOGUS USERNAME.      //// 
/////////////////////////////////////////////////
exports.validatorUser = function(req, res, next) {
  ...
  if(containsSpecialCharacters(ids)){
    ids=''
  }
  next();
}
...
exports.profilepic = function(req, res) {
  ...
  if (true) {}
        ...
        User.findOne({ username: ids }, function(err, username) {
          if(err){console.log('Error Here get collectionsdata'); 
          res.send({username:{
            image:''
          }})
          return;}     
          ...
          if (username) {
            res.send({
              image : JSON.stringify(username.image),
