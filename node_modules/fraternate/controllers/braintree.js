...
exports.transactions = function(req, res) {
  res.render(directory+'/views/transactions', {
        ...
        gateway.customer.find(req.user.braintreeid, function(err, customer) {
          if (customer) {
           gateway.clientToken.generate({
            ...
            res.render(directory+'/views/settings/payment',{
        ...
        gateway.customer.find(req.user.braintreeid, function(err, customer) {
          if (customer) {
           gateway.clientToken.generate({
            ...
            res.render(directory+'/views/settings/upgrade',{
        ...
        gateway.customer.find(req.user.braintreeid, function(err, customer) {
          if (customer) {
           gateway.clientToken.generate({
            ...
            res.render(directory+'/views/settings/upgrade_plan_2',{
