...
<body>
 ...
 <br>
 <div class="login-container container" style="padding-bottom: 35px">
  <a href="/">
 ...
 <div style="text-align: center;padding-bottom: 15px">
  <h4>Contact the {{siteName}} Team</h4>
</div>
<div class="panel panel-default" id="sendingarea" >
    ...
    <div class="card" style="">
      <div class="card-body">
       <form method="POST" class="form-horizontal">
        ...
        <div class="form-group">
          <label for="message" class="col-md-12">How can we help?</label>
          <div class="col-md-12">
            <textarea name="message" placeholder="Please describe exactly what you’re trying to accomplish." id="message" rows="7" class="form-control"></textarea>
          </div>
        </div>
        <div class="form-group">  
         <div class="col-md-12">
