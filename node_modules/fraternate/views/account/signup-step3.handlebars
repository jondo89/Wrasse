      ...
      <div class="col align-self-center">
        ...
        <table class="table table-bordered" style="border-radius: 5px">
          <tr>
           ...
           <td style="padding-bottom: 22px;width: 33%;text-align: center;color:grey"  >
            <h3 style="color:grey"><i class="fas fa-check"></i> <strong class="step" style="font-size:24px">Step 2</strong></h3>
            Choose your plan (Complete)
          </td>
...
<div class="col-9">
                <div class="col-md-11 form-group" style="display: none;">
             ...
             <div class="form-group">
              ...
              <p class="help-block">This email will be shown on your public profile. </p>
            </div>
          </div>     
 ...
 <small><em>All of the fields on this page are optional and can be deleted at any time, and by filling them out, you're giving us consent to share this data wherever your user profile appears. Please see our <a href="/privacy" target="_blank">privacy statement</a> to learn more about how we use this information.</em></small>
          ...
          <div class="form-group">
            <div class=" col-sm-4">
              <button type="submit"   id="export" class="btn btn-primary">Update Profile</button>
            </div>
          </div>
