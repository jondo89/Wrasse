...
<ul class="nav nav-tabs" role="tablist">
  ...
  {{#if orgowner}}
  <li class="nav-item" role="presentation"><a class="nav-link active" href="/organizations/{{organization.entry.name}}/settings/profile" role="tab"> Settings</a></li>
  {{else}}
  {{/if}}
</ul>
<div class="row" style="padding-top: 25px">
  ...
  <div class="card-header">
        ...
        <a href="/organizations/{{organization.entry.name}}/settings/billing-paypal" class="list-group-item active">Billing - PayPal</a>
      </ul>
    </div>  
  </div>  
  <div class="col-md-9" id="browserArea">
    ...
    <p><a class="btn btn-outline-secondary" href="/organizations/{{organization.entry.name}}/settings/billing/upgrade">Get private repositories</a></p>
    {{/if}} 
    ...
    <div class="btn-group" role="group" aria-label="...">
      <a class="btn btn-outline-secondary" href="/organizations/{{organization.entry.name}}/settings/billing/payment"><i class="fa fa-credit-card" aria-hidden="true"></i> Edit payment method</a>
    ...
    <p><a class="btn btn-outline-secondary" href="/organizations/{{organization.entry.name}}/settings/billing/payment"><i class="fa fa-credit-card" aria-hidden="true"></i> Add payment method</a></p>
    {{/if}}
    <hr>
            ...
            <div class="media-body">
              <div class="row">
               ...
               <div class="col-md-3" style="text-align:right" >
                <a class="btn btn-outline-secondary btn-xs" data-toggle="modal" data-target="#myModal" id="{{this}}" onclick="kickMember(this.id)"><i class="fa fa-times" aria-hidden="true" ></i> Kick</a>
              </div>
            </div>
          </div>
        </div>
...
{{/if}}
<p>
  <a class="btn btn-outline-secondary" href="/organizations/{{organization.entry.name}}/settings/billing/billing_managers/new"><i class="fa fa-user" aria-hidden="true"></i> Add a billing manager</a>
</p>
