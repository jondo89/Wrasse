...
<div class="row" style="padding-top: 25px">
  ...
  <div class="col-md-9" id="browserArea">
    ...
    <form method="POST" action="/organizations/{{organization.entry.name}}/?_method=PUT" class="auto-approve" >
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="form-group" style="display: none;">
            <label for="displayname" class="col-12">Organization username</label>
            <div class="col-11 form-group">
              <input type="displayname" name="name" id="name" class="form-control" value="{{organization.entry.name}}" disabled>
              <p class="help-block">Organization name changes can have unforeseen consequences. <a class="btn btn-outline-secondary btn-xs" href="/contact" >Request new name</a></p>
            </div>
          </div>

          <div class="form-group">
            <label for="displayname" class="col-12">Display name</label>
            <div class="col-11 form-group">
          ...
          <div class="form-group">
            <div class="col-11 form-group">
             ...
             <div class="col-md-12">
               <div class="form-group">
                <label for="displayname" class="col-12">Billing Name</label>
      ...
      {{/if}}
      <div class="form-group">
        <label for="displayemail" class="col-12">Email (will be public)</label>
        <div class="col-11 form-group">
      ...
      <div class="form-group">
        <label for="displayname" class="col-12">Description</label>
        <div class="col-11 form-group">
      ...
      <div class="form-group">
        <label for="displayname" class="col-12">Url</label>
        <div class="col-11 form-group">
     ...
     <div class="form-group">
      <label for="email" class="col-12">Billing email (Private)</label>
      <div class="col-11 form-group">
    ...
    <div class="form-group">
      <div class="col-4">
        <button type="submit"    id="export"  class="btn btn-outline-secondary">Update Profile</button>
      </div>
    </div>
  </div>
  <div class="col-md-4">
...
<div class="form-group">
        ...
        <form method="POST" action="" class="form-horizontal">
          <div class="form-group">
            <p class=" col-9" style="color:#d9534f">You can delete this organization, but keep in mind this action is irreversible.</p>
            <div class=" col-9">
