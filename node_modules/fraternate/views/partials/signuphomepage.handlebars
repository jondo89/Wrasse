    ...
    <div class="card-body">
      ...
      <form method="POST" action="/signup" class="auto-approve">
        <div class="form-group">   
          <input type="text" name="username" id="username" autocomplete="username" placeholder="Pick a username" class="form-control" data-validate='{
          "title":"Text",  
          "alphaNumeric": true,
      ...
      <div class="form-group">
        <input type="email" name="email" id="email" autocomplete="email" data-validate='{
        "title":"Email",
        "email": true
      }' placeholder="Email" class="form-control">
    </div>
    <div class="form-group">
      <input type="password" name="password" id="password" autocomplete="password" placeholder="Password" class="form-control"
      data-validate='{
      "title":"Password",
      "strength": {
      "min": 8,
