...
<div class="row" style="padding-top: 25px">
	...
	<div class="col-md-9" id="browserArea">
		...
		<p><a class="btn btn-outline-secondary mt-4" href="/users/{{user.username}}/settings/billing/upgrade">Get private repositories</a></p>
		{{/if}}		
		<hr>
		<h4>Payment</h4>
		{{#if braintree_customer}}
		<div class="btn-group" role="group" aria-label="...">
			<a class="btn btn-outline-secondary" href="/users/{{user.username}}/settings/billing/payment"><i class="fa fa-credit-card" aria-hidden="true"></i> Edit payment method</a>
		...
		<p><a class="btn btn-outline-secondary mt-4" href="/users/{{user.username}}/settings/billing/payment"><i class="fa fa-credit-card" aria-hidden="true"></i> Add payment method</a></p>
		{{/if}}
		<hr>
