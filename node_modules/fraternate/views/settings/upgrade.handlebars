...
{{else}}
	...
	<hr>
	<div class="btn-group"  >
		<a href="/users/{{user.username}}/settings/billing/upgrade" class="btn btn-outline-secondary btn-lg active">
			<input type="radio" name="options" id="option1" autocomplete="off" style="position: relative;" checked> <strong>$7 / month </strong>
		</a>
		<a href="/users/{{user.username}}/settings/billing/upgrade_plan_2" class="btn btn-outline-secondary btn-lg " >
