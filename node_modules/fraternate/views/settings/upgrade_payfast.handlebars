...
<div class="row">
	<div class="col-md-3">
		...
		<div>
			<div>  
				<a href="/{{user.username}}">
					{{#if user.image}}
					<div onerror="this.src='{{user.gravatar}}'"" id="googlepic" style="min-width: 25%;max-width: 100%;"></div>
					{{else}}
					<img src="{{user.gravatar}}" class="media-object" style="max-width: 100%;">
					{{/if}}
				</a>
			</div>
		</div>
		...
		{{else}}<br>
		<h4>{{user.name}} {{user.lastname}}  <br><small>{{user.username}}</small></h4>
		<hr>
		<h5>Current plan</h5>
		...
		<div class="row">
			<div class="col-md-12" style="">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="awesome">
							<div class="card" style="margin-bottom: 1px;border-color: #5cb85c; "  >
								<div class="card-body" >
									Charge today
									<h1 id="pricingNow">ZAR 100.00/Month</h1>
									<a href="" class="btn btn-outline-success" data-price="100.00" data-cycles="0" data-frequency="3" id="btn1" onclick="price(this.id)" >
										Select
									</a>
								</div>
								<div class="card-footer">Your next charge will be on <span id="dates"></span>.</div>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="awesome">
							<div class="card" style="margin-bottom: 1px;border-color: #5cb85c; "  >
								<div class="card-body" >
									...
									<a href="" class="btn btn-outline-success collapsed" data-price="1200.00" data-cycles="0" data-frequency="6" id="btn2" onclick="price(this.id)" >
										Select
									</a>								
								</div>
								<div class="card-footer">Your next charge will be on <span id="years"></span>.</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div> 
					<div class="form-row">
						<div class="col-md-6">
							...
							<label class=" control-label" for="textinput">Amount (Rand): </label>  
			...
			<div class="col-md-6">
				...
				<label class=" control-label" for="textinput">Receipt Email: </label>  
...
<script type="text/javascript">
	...
	$('#googlepic').html('<img src="'+text+'" style="max-width: 100%;border-radius: 2px;border: 1px;border-color: #d8d8d8;border-style: solid;" class="media-object">')
	var checkout;
//////////////////////////////////////////////////////
