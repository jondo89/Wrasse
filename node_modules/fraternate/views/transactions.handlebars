...
<h1><a href="https://www.braintreepayments.com/" target="_blank"><img style="max-width: 155px" src="/img/logo/braintree.png"></a>   Braintree Transaction history. </h1>
...
<hr>
<div class="alert alert-info" role="alert"><strong>Heads Up!</strong> These are demonstration payments on the PayPal Sandbox account. Actual credit card details will not parse into this Fraternate demo.</div>
<div class="row">
  <div class="col-md-6">
