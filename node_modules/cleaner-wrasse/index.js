		...
		'create':[
			{
				...
				'url':'/issues/newgroup/',
				'type':'get',
				'route':[ wrasseRead.newissuegroup ],
				'description':'Static HTML page deploy the form.'
			}
		],
		'read':[
			...
			},
			{
				'url':'/issues/group/',
				'type':'get',
				'route':[wrasseRead.getallissues, wrasseRead.readissuesbygroup ], 
				'description':'Static HTML page deploy of grpuped issues.'
			},
			{
				'url':'/issues/view/:receivedid',
				'type':'get',
				'route':[wrasseRead.getissue, wrasseRead.getparent, wrasseRead.readissuebyid ], 
				'description':'Static HTML page deploy issue by id with children.'
			},
		],
		'update':[
			{
				...
				'url':'/issues/getform/',
				'type':'get',
				'route':[  wrasseRead.getform ],
				'description':'AJAX HTML page deploy the form, lank or with data.'
			}
		],
		'delete':[
			{
