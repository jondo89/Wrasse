...
var wrasserouting = {
	...
	'read':[
	{
		...
		'url':'/issues/user/view/:username',
		'type':'get',
		'route':[wrasseRead.getallissues, wrasseRead.readissues ], 
		'description':'Static HTML page deploy of all issues.'
	},{
		'url':'/issues/getissuecount/:receivedid',
		'type':'get',
		'route':[wrasseRead.getallissues, wrasseRead.getissuecount ], 
		'description':'Get a count of the issues for this parent.'
	},	],
	'update':[
	{
		...
		'url':'/issues/close/:closeid/:receivedid',
		'type':'get',
		'route':[wrasseRead.closeissue,wrasseRead.getallissues, wrasseRead.readissues ], 
		'description':'Static HTML page deploy of all issues.'
	},{
		'url':'/issues/close/:closeid/',
		'type':'get',
		'route':[wrasseRead.closeissue,wrasseRead.getallissues, wrasseRead.readissues ], 
		'description':'Static HTML page deploy of all issues.'
	}
	...
	'delete':[
	{
		'url':'/issues/delete/:deleteid/:receivedid',
		'type':'get',
		'route':[ wrasseDelete.deleteitem,wrasseRead.getallissues, wrasseRead.readissues ],
