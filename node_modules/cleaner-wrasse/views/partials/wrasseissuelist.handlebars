    ...
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td style=" min-width: 35px">
            ...
            <a href="/users/{{username}}">
              <img id="{{username}}" src="https://www.gravatar.com/avatar/{{user._id}}?s=92&d=retro&r=G" class="img-fluid mr-1 userpic" style="border-radius: 4px;min-width:80px;max-width:200px;">
            </a>
            {{else}}
            {{>randompicsm}} 
            {{/if}}      
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div style="text-align: right;">
                      ...
                      {{/ifEquals}}
                      <a href="/issues/view/{{this.parentid}}" title="View group of issues."><span class="badge badge-secondary">{{this.parentid}}</span></a>  
                    </div>
                  </div>
                </div>
        ...
        <td>            <div class="col-md-1">
          ...
          {{#if ../user}}
          <div  class="dropdown">
            <a title="Modify this item." class="btn btn-outline-secondary btn-sm " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <script type="text/javascript">
                ...
                function alertCloseIssue(ids){
                  ...
                  if( result ){
                    //console.log('/issues/close/'+ids+'/{{../parentid}}')
