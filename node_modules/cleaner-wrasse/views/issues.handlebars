<div class="row">
  ...
  <div class="btn-group" role="group" aria-label="...">
    <a  class="btn btn-default btn-xs"  data-toggle="modal" data-target="#myModal" onclick="newMenuItem()" title="Add items"><i class="fa fa-plus" aria-hidden="true"></i></a>
    <a  class="btn btn-default btn-xs"  data-toggle="modal" data-target="#myModal" onclick="editRaw()" title="Edit this item raw"><i class="fa fa-file-code-o" aria-hidden="true"></i></a>
</div>
...
function loadformModalwrasse(formdata,idItem,raw,parentid,headings,entry){
  ...
  jQuery.ajax({
    'url': '/issues/getform?formdata='+formdata+'&idItem='+idItem+'&raw='+raw+'&parentid='+parentid+'&headings='+headings+'&entry='+entry,
    'async': true,
    'global': false,
